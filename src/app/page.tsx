    ...
    <MainLayout>
      <div className="flex flex-col gap-12">
        ...
        <Card className="bg-primary/5 border-primary/20">
            <CardHeader>
                <CardTitle className="font-headline">Siap Memulai?</CardTitle>
                <CardDescription className="font-body">Jelajahi fitur-fitur yang ada untuk mengoptimalkan manajemen kafe Anda hari ini.</CardDescription>
            </CardHeader>
            <CardContent>
